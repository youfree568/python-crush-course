...
class AlienInvasion:
	...
	def _check_bullet_alien_collisions(self):
		"""activiti when bullets hit aliens"""
		# remove all bullets and aliens who had crashed
	...
	def _update_aliens(self):
		...
		# seek if some alien cross the bottom screen
		self._check_aliens_bottom()

	def _ship_hit(self):
		"""reaction when ship hit with aliens"""
		if self.stats.ship_left > 0:
			# reduce ship_left
			self.stats.ship_left -= 1

			# delete bullet and aliens
			self.aliens.empty()
			self.bullets.empty()
	...
	def _check_aliens_bottom(self):
		"""check if aliens touch end of the screen"""
